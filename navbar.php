  ...
  <div class="container">
         ...
         <nav class="navbar navbar-inverse navbar-fixed-top gabanav">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar" style="background-color:white" style="background-position:fixed" >
              <ul class="nav navbar-nav gabali">
                <li><a href="index.php">Home</a></li>
                <li><a href="buslist.php">Vehicle</a></li>
                <li><a href="pricelist.php">price chart</a></li>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar"style="background-color:white" style="background-position:fixed">
              <ul class="nav navbar-nav gabali">
                ...
                <li><a href="feedback.php?id=<?php echo $_SESSION['username'];?>">Feedback</a><li>
